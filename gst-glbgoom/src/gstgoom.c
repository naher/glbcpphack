 ...
 * |[
 * gst-launch -v audiotestsrc ! glbgoom ! ffmpegcolorspace ! xvimagesink
 * ]|
 * </refsect2>
 */
...
GST_ELEMENT_DETAILS ("glb-GOOM: what a GOOM!",
    "Visualization",
    "Takes frames of data and outputs video frames using the GOOM filter",
    "thanks to Wim Taymans <wim@fluendo.com>");
